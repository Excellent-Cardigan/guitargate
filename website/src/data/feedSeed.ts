...
export const SEED_ACTIVITY: ActivityItem[] = [
  {
    ...
    hearts: 12, liked: false,
    parts: [{ name: 'Jonah', instrument: 'Electric guitar' }, { name: 'Sam', instrument: 'Drums' }],
    loadedToPedal: true, scope: 'everyone',
    reactions: [{ user: 'Jonah', text: 'that bend is clean' }],
  },
  {
    id: 'loop-2', type: 'loop', user: 'Devon K.', time: '5h ago',
    title: 'Little Wing — rhythm pass',
    hearts: 8, liked: false, parts: [], loadedToPedal: false, scope: 'everyone',
    reactions: [],
  },
  {
    id: 'loop-3', type: 'loop', user: 'Priya S.', time: '1d ago',
    title: 'Vibrato Technique — slow practice loop',
    hearts: 15, liked: false, parts: [{ name: 'Sam', instrument: 'Drums' }],
    loadedToPedal: true, scope: 'everyone',
  ...
  },
  {
    ...
    hearts: 6, liked: false, parts: [], loadedToPedal: false, scope: 'everyone',
    reactions: [],
  },
  {
    ...
    hearts: 9, liked: false,
    parts: [
      { name: 'Mara', instrument: 'Electric guitar' },
      { name: 'Jonah', instrument: 'Electric guitar' },
      { name: 'Devon', instrument: 'Bass' },
    ],
    loadedToPedal: false, scope: 'everyone',
    reactions: [{ user: 'Mara', text: 'love this tone' }],
  },
  {
    id: 'loop-6', type: 'loop', user: 'Sam W.', time: '3d ago',
    title: 'Little Wing — solo attempt #2',
    hearts: 4, liked: false, parts: [], loadedToPedal: false, scope: 'everyone',
    reactions: [],
  },
  {
    id: 'loop-7', type: 'loop', user: 'Devon K.', time: '6h ago',
    title: 'Vibrato Technique — second try',
    hearts: 3, liked: false, parts: [], loadedToPedal: false, scope: 'friends',
    reactions: [],
  },
  {
    id: 'loop-8', type: 'loop', user: 'Priya S.', time: '1d ago',
    title: 'Cliffs of Dover — intro only',
    hearts: 5, liked: false, parts: [], loadedToPedal: false, scope: 'friends',
  ...
  },
  {
    ...
    hearts: 2, liked: false, parts: [], loadedToPedal: false, scope: 'friends',
    reactions: [],
  },
  {
